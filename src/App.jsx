...
function App() {
  ...
  <div className="w-[100vw] h-[100vh] flex justify-center items-center bg-[#344151] flex-col gap-10">
    ...
    <div className="bg-white flex justify-center gap-12 pd-3 rounded-sm text-[25px] text-[#344151]">
    ...
    <button onClick={resetHandler} className="bg-[#0398d4] text-white px-2 py-2 rounded-5m text-lg">
      Reset
      </button>
  </div>
  );
